...
- GitHub: https://github.com/mihir0209/AI_engine
- Docs: https://github.com/mihir0209/AI_engine/tree/main/docs

## Tags

`ai` `llm` `openai` `self-hosted` `python` `fastapi` `docker` `free` `proxy` `router`

## Submission targets

1. **awesome-selfhosted** — fits under AI category
2. **awesome-python** — fits under AI/ML section
3. **cheahjs/free-llm-api-resources** — PR to add as a tool that aggregates free providers
