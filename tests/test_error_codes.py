...
def test_error_response_to_dict():
    from core.error_codes import ErrorResponse, ErrorCode
    error = ErrorResponse(
        error="Test Error",
...
def test_factory_provider_not_found():
    from core.error_codes import ErrorFactory
...
def test_get_http_status_code():
    from core.error_codes import get_http_status_code, ErrorCode
